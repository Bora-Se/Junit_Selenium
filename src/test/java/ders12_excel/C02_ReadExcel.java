...
public class C02_ReadExcel {
    ...
    public void readExcelTesti() throws IOException {
        ...
        //String dosyaYolu= System.getProperty("user.home")+ "\\Downloads\\ulkeler.xlsx";
        //String dosyaYolu= System.getProperty("user.home")+ "/Downloads/ulkeler.xlsx"; //(Sistem belirtilen dosyayi bulamiyor)
        String dosyaYolu= System.getProperty("user.home")+"\\Desktop\\FileTest\\ulkeler.xlsx";
