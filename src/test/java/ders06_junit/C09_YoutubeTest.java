...
public class C09_YoutubeTest {
    ...
    public static void setUp() {
        ...
        //tp-yt-paper-button[@class='style-scope ytd-button-renderer style-primary size-default'])[2]
        //yt-formatted-string[text()='Accept all'] ahmet hocanin Xpath i
    ...
    public void aramaKutusuTesti(){
        ...
        Assert.assertTrue(((WebElement) aramaKutusu).isEnabled());
    }
